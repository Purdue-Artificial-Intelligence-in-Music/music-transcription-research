...
The research progress for the Music Transcription team within AI for Musicians at Purdue University. This project provides a comprehensive framework for evaluating Automatic Music Transcription (AMT) models through automated benchmarking on the Gilbreth/Anvil computing cluster.
...
-   **`server.py`** - Gilbreth/Anvil cluster deployment and job execution through remote server
...
**Deploy to Gilbreth/Anvil cluster:**
...
4. **Update `models.json`:**
    ```json
    {
        "values": [["ModelName", "https://github.com/user/repo.git", "username", "token"]]
    }
    ```
...
-   **Purdue University RCAC** for Gilbreth/Anvil cluster access
...
_This research is conducted as part of the AI for Musicians project at Purdue University, focusing on advancing automatic music transcription through comprehensive benchmarking and evaluation._
