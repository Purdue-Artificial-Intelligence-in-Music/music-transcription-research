...
curl -d "Started running model $1 for dataset $dataset_name" -H "Title: Started running model" -H "Priority: default" -H "Topic: gilbreth-notify-amt" ntfy.sh/gilbreth-notify-amt
